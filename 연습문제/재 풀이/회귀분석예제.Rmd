...
##### 이 자료를 바탕으로 해서 회귀식을 구하고 아버지의 키가 165cm일 때 아들의 키는 얼마인지 예측하시오.
```{r}
...
##### 이 자료를 바탕으로 해서 회귀식을 구하고, 월 소득이 250만원일 때 신용카드 사용량을 예측하시오.
```{r}
...
summary(d_bic_lm_3)
# 이제 모든 값이 유의미하다고 판단되므로 다시 그래프로 판단한다.
...
##       chas        nox         rm    I(rm^2)        dis    ptratio   black      lstat     I(lstat^2) 
##   1.044202   3.081682 124.532714 126.400108   2.638449   1.331315  1.246113  23.268060  18.435938
```
